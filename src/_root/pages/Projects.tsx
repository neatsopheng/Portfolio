  ...
  const myProject = [
    {
      ...
      language:
        "React, TypeScript, React Router Dom, Zustand, React Query, Axios, JSON Server",
    ...
    },
    {
      ...
      features: "User can Browse for games library randomly. They also can browse by filtering include filter by search, by category, \
    ...
    },
    {
      ...
      link: "Not Available",
      features: "This project integrated with authentication and authorization. User able to login or sign up for an account,\
      User can post what is up to their mind, User can scroll the feed to see other user's post. User can like or save post.",
      img: project2IMG,
    },
  ];
  return (
    <section id="projects" className="projects-section bg-[#121222] py-20 h-auto">
      <div>
          ...
          <Fragment key={i.title}>
            ...
            <div className="w-full md:w-[699px] lg:w-full p-10 bg-[#2f4d31] rounded-lg flex flex-col md:flex-row items-center justify-evenly gap-20 mg:gap-0">
              ...
              <div className=" flex-1 bg-[#3a5c3d] p-2 md:p-7 rounded-lg ">
                ...
                <p><span className="text-yellow-500 underline">Language: </span>{i.language}</p>
                <span>
                Link:
                <a href={i.link} target="_blank" className="text-blue-500 hover:text-blue-400"> {i.link}</a>
