  ...
  const myProject = [
    {
      ...
      language:
        "React, TypeScript, React Context-API, Shadcn-ui + TailwindCSS, appwrite",
      link: "Not Available",
      features:
          ...
          .map((i, index) => (
            <Fragment key={i.title}>
              <div
                ...
                className="w-full md:w-[699px] lg:w-full p-10 bg-[#2f4d31] rounded-lg flex flex-col md:flex-row items-center justify-evenly gap-20 mg:gap-0"
              >
                ...
                >
                  ...
                  <SwiperSlide>
                    <div className="bg-[#3a5c3d] p-2 md:p-7 rounded-lg ">
                      ...
                      <p className="overflow-x-auto scrollbar-thin">
                        {i.features}
                      </p>
                    </div>
                  </SwiperSlide>
